...
INSERT INTO tests(p_id, test_name, test_result, test_date, doc_id, comments)
	VALUES(2008, 'Arthroscopy', 'JoINTEGER Broken', '10/05/2019', 1010,'Blood cloting');
INSERT INTO tests(p_id, test_name, test_result, test_date, doc_id, comments)
...
INSERT INTO appointments( appointment, p_id, doc_id, app_date, app_status)
	VALUES( 'Marriage Counselling', 2006, 1004, '05/05/2018','Rescheduled to 05/06/2018');
INSERT INTO appointments( appointment, p_id, doc_id, app_date, app_status)
	VALUES( 'Marriage Counselling', 2006, 1004, '05/06/2018','Done');
INSERT INTO appointments( appointment, p_id, doc_id, app_date, app_status)
	VALUES( 'HIV/AIDS Counselling', 2010, 1009, '05/07/2018','Done');
INSERT INTO appointments( appointment, p_id, doc_id, app_date, app_status)
	VALUES( 'Surgery Counselling', 2009, 1004, '06/07/2018','Pending');
INSERT INTO appointments( appointment, p_id, doc_id, app_date, app_status)
	VALUES( 'Marriage Counselling', 2006, 1004, '07/07/2018','Done');
INSERT INTO appointments( appointment, p_id, doc_id, app_date, app_status)
	VALUES( 'Sex Therapy', 2008, 1009, '08/07/2018','Done');
INSERT INTO appointments( appointment, p_id, doc_id, app_date, app_status)
	VALUES( 'Stress Management', 2004, 1004, '10/07/2018','Done');
INSERT INTO appointments( appointment, p_id, doc_id, app_date, app_status)
	VALUES( 'Relaxation Therapy', 2002, 1009, '02/01/2019','Done');
INSERT INTO appointments( appointment, p_id, doc_id, app_date, app_status)
	VALUES( 'Diet Counselling', 2001, 1004, '11/08/2019','Pending');
INSERT INTO appointments( appointment, p_id, doc_id, app_date, app_status)
	VALUES( 'Healthy Living Counselling', 2009, 1004, '11/08/2019','Done');
...
INSERT INTO consultations(p_id, cons_date, doc_id, remarks)
	VALUES(2004, '03/03/2019', 1003,'Colds, joINTEGER pains, Headaches');
INSERT INTO consultations(p_id, cons_date, doc_id, remarks)
...
INSERT INTO contacts( user_id, phone, email)
	VALUES(1010, '0712678945','example2x@gmail.com');
INSERT INTO contacts( user_id, phone, email)
	VALUES(3003, '0704048484','emailxxa@gmail.com');
...
INSERT INTO inpatients( p_id, bed_no, room_id, nurse_id, remarks)
	VALUES(2008,9,4,3009,'Requires Pain Relievers');